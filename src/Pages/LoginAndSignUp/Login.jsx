...
const Login = () => {
  ...
  return (
    <div className="relative ">
      ...
      <div className="lg:w-11/12 mx-auto min-h-screen flex h-full p-3 lg:p-5 rounded-3xl my-5 lg:mt-10  items-center justify-center">
        {" "}
        <div
          style={{ boxShadow: "0px 0px 10px 0 #0b2447" }}
          className="card border-2 border-[#0b2447] order-2 flex-shrink-0 w-full  lg:h-[590px]   h-full shadow-2xl "
        >
          <div className="lg:h-[590px]    rounded-3xl w-full hidden lg:block absolute backdrop-blur-xs lg:backdrop-blur-xs bg-opacity-5  "></div>
          <form
          ...
          >
            <div className="lg:w-1/2 z-0">
              <h1 className="text-center font-KaushanScript z-0 my-5 mb-14 text-3xl lg:text-4xl theme-text">
                Welcome Back
              </h1>
