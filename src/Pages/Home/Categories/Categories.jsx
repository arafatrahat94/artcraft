...
const Categories = () => {
  return (
    <div id="Category" className="lg:my-32 my-20">
      ...
      <div className="flex gap-x-4  gap-y-3 justify-center items-center  mt-10 w-10/12 mx-auto">
        <Link
          to={`/Category/${"Water"}`}
          className="lg:w-[250px] hover:ring hover:scale-105 ring-pink-600 transform duration-300 h-[250px] relative bg-black rounded-[3.5rem]"
        >
          <img
