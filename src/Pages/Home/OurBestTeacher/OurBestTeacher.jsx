...
const OurBestTeacher = () => {
  ...
  return (
    <div id="instructors" className=" mb-10 lg:w-11/12 lg:mx-auto mx-3">
      {/* best tutor */}
      <div className="theme-color1 pb-2 lg:pb-0 lg:h-[700px] bg-opacity-5 theme-border border-opacity-40 rounded-tr-[3rem] rounded-bl-[3rem] ">
        <h1 className="text-center mt-10 text-3xl lg:text-5xl font-KaushanScript theme-text">
        ...
        <div className="mt-7">
          <Swiper
            ...
            className="mySwiper flex items-center justify-center  h-[490px] lg:w-[97%] w-full mx-auto"
            loop={true}
          >
            <SwiperSlide className=" flex justify-center w-72  items-center">
              <div className="relative theme-text flex mx-5 lg:mx-0 flex-col  rounded-b-[3rem] pb-1  bg-white bg-clip-border  shadow-xl shadow-[#ee5c541c]">
