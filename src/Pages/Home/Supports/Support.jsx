  ...
  return (
    <div className="lg:h-40 mb-5">
      <div className="grid mt-[250px] lg:mt-0 grid-cols-1 lg:grid-cols-3 h-full w-11/12 mx-auto rounded-2xl gap-y-5">
        ...
        <div className="-z-10 lg:z-10 flex gap-x-3 bg-i font-VarelaRound items-center flex-col rounded-tl-3xl absolute  right-2 lg:right-0 w-[250px] lg:w-[334px] rounded-br-3xl h-[300px] lg:h-[270px]   gap-y-2 bg-opacity-20 top-[650px] lg:top-[520px]  justify-center theme-text font-semibold">
          <h1>
